...
SDL_FreeSurface(&e.posSprite[e.ligne][e.col]);
	/**
* @brief to blit ennemi.
* @param e to ennemi
* @param ecran to screen
* @return Nothing
*/
}
...
return collision ;
/**
* @brief to make bounding box collision.
* @param e to ennemi
* @param poshero to hero positions
* @return collision
*/
}
